...
def run_once(func): # -> _Wrapped[..., Any, ..., Any]:
    ...
...
def image_to_string(image, lang=..., config=..., nice=..., output_type=..., timeout=...): # -> bytes | str | dict[str, bytes | str]:
    """
...
def image_to_boxes(image, lang=..., config=..., nice=..., output_type=..., timeout=...): # -> bytes | str | dict[Any, Any]:
    """
...
def image_to_data(image, lang=..., config=..., nice=..., output_type=..., timeout=..., pandas_config=...): # -> bytes | str | dict[Any, Any]:
    """
...
def image_to_osd(image, lang=..., config=..., nice=..., output_type=..., timeout=...): # -> bytes | str | dict[str, float | int | str]:
    """
