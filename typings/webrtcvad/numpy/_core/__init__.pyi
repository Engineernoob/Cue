...
from numpy._typing import NDArray, _AnyShape, _ArrayLikeAnyString_co as UST_co, _ArrayLikeBytes_co as S_co, _ArrayLikeInt_co as i_co, _ArrayLikeStr_co as U_co, _ArrayLikeString_co as T_co, _SupportsArray

__all__ = ["add", "capitalize", "center", "count", "decode", "encode", "endswith", "equal", "expandtabs", "find", "greater", "greater_equal", "index", "isalnum", "isalpha", "isdecimal", "isdigit", "islower", "isnumeric", "isspace", "istitle", "isupper", "less", "less_equal", "ljust", "lower", "lstrip", "mod", "multiply", "not_equal", "partition", "replace", "rfind", "rindex", "rjust", "rpartition", "rstrip", "startswith", "str_len", "strip", "swapcase", "title", "translate", "upper", "zfill", "slice"]
...
@overload
def slice(a: U_co, start: i_co | None = ..., stop: i_co | None = ..., step: i_co | None = ..., /) -> NDArray[np.str_]:
    ...

@overload
def slice(a: S_co, start: i_co | None = ..., stop: i_co | None = ..., step: i_co | None = ..., /) -> NDArray[np.bytes_]:
    ...

@overload
def slice(a: _StringDTypeSupportsArray, start: i_co | None = ..., stop: i_co | None = ..., step: i_co | None = ..., /) -> _StringDTypeArray:
    ...

@overload
def slice(a: T_co, start: i_co | None = ..., stop: i_co | None = ..., step: i_co | None = ..., /) -> _StringDTypeOrUnicodeArray:
    ...
