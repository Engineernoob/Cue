...
c_intp = _c_intp
@overload
def ndpointer(dtype: None = ..., ndim: int = ..., shape: _ShapeLike | None = ..., flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_ndptr[None]]:
    ...

@overload
def ndpointer(dtype: _DTypeLike[_ScalarT], ndim: int = ..., *, shape: _ShapeLike, flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_concrete_ndptr[dtype[_ScalarT]]]:
    ...

@overload
def ndpointer(dtype: DTypeLike, ndim: int = ..., *, shape: _ShapeLike, flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_concrete_ndptr[dtype]]:
    ...

@overload
def ndpointer(dtype: _DTypeLike[_ScalarT], ndim: int = ..., shape: None = ..., flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_ndptr[dtype[_ScalarT]]]:
    ...

@overload
def ndpointer(dtype: DTypeLike, ndim: int = ..., shape: None = ..., flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_ndptr[dtype]]:
    ...
