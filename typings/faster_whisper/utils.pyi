...
def download_model(size_or_id: str, output_dir: Optional[str] = ..., local_files_only: bool = ..., cache_dir: Optional[str] = ..., revision: Optional[str] = ..., use_auth_token: Optional[Union[str, bool]] = ...): # -> str:
